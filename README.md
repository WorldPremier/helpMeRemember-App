...
## All protorype UI buttons will have to be malleable meaning instantiating ternaries logical conditions based on what the user sets as a key missing item to remember as a pre set-up and ready to render all leading up to the final product or destination.  
